              ...
              {users &&
                users.map((user, index) => (
                  ...
                  <Link href={`/${user.username}`} className="text-xs text-blue-500" key={index}>
                    <div
                      className="flex items-center justify-center space-x-5 p-2 bg-gray-100 rounded-lg cursor-pointer hover:bg-gray-200 transition"
                      key={user.id}
                    >
                      {/* Profile Picture */}
                      ...
                      <div>
                        ...
                        <div className="mb-3 text-center">
                          <span className="font-medium text-gray-800 text-[.9rem]">
                            {user.username}
                          </span>
                        </div>
