    ...
    return (
        <nav className="flex justify-center items-center gap-x-1" aria-label="Pagination">
            ...
            <div className="flex items-center gap-x-1">
                <span className="min-h-[38px] min-w-[38px] flex justify-center items-center bg-white/20 text-white py-2 px-3 text-sm rounded-full focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none">{currentPage}</span>
