...
const TopBar = () => {
    ...
    return (
        <div className="flex max-md:flex-col justify-center w-full h-fit gap-x-4 bg-white/10 text-white/75 border-t">
            <Link
                href={"/l_game"}
                className='flex items-center justify-center hover:bg-white/25 text-sm w-full sm:w-56 px-4 py-2  font-bold font-mono hover:opacity-90 active:ring active:ring-white/50 uppercase text-center'
            >
