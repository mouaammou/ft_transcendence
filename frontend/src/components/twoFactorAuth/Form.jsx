    ...
    return (
        <div className="group relative w-full h-fit p-[1px]">
            ...
            <div className="relative flex items-center justify-center gap-4 text-white bg-white/30 group-focus-within:text-green-400 font-bold w-full h-full px-4 py-2">
                ...
                <input autoComplete='off' id='2fa-code-lkmdg' name='2fa-code' onChange={onChange} value={value} placeholder={placeholder} maxLength={maxlength} className="placeholder:text-white/50 placeholder:font-light placeholder:text-md text-white bg-transparent border-none outline-none w-full" required type="text" />
            </div>
        </div>
    );
}
