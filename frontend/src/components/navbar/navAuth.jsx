							...
							<div className="relative">
								...
								{isOpen && (
									<div onMouseLeave={() => setIsOpen(false)} className="z-50 absolute right-3 mt-4 text-base list-none divide-y rounded-lg shadow-lg w-48 bg-gray-800 text-gray-400">
										...
										<ul className="py-2">
											<li>
												<Link href="/profile" className="block px-4 py-2 text-sm text-white hover:text-gray-700 hover:bg-gray-100">
													Profile
												</Link>
											</li>
											<li>
												<Link href="/settings" className="block px-4 py-2 text-sm text-white hover:text-gray-700 hover:bg-gray-100 ">
													Settings
												</Link>
											</li>
											<li>
												<Link href="/tournament" className="block px-4 py-2 text-sm text-white hover:text-gray-700 hover:bg-gray-100 ">
													Create Tournament
												</Link>
											</li>
											<li>
